...
import os
url= 'budget_data.csv'
csvpath =os.path.join('..', 'Resources', url)
print(csvpath)
...
m=0
for m in range (j):
  if int(Change[m])<0 and Increase <= int(Change[m]):    
      Increase=Increase+ Change[m]
      print ("k")        
...
print("Greates Increase in profits: ",Indexm," ",Increase)
